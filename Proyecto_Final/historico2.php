...
$query = "SELECT d.iddata, d.Latitude, d.Longitude, d.Date, d.Hour, v.CarbonDioxide, v.CarbonMonoxide, v.Ammonium FROM data2 as d, values2 as v WHERE d.iddata = v.idvalues AND d.Date between '".$datetime_start."' AND '".$datetime_end."' ORDER BY d.iddata";
